		...
		describe "authorization" do
			...
			describe "for non-signed-in users" do
				...
				describe "in the Users controller" do
					...
					describe "when attempting to visit protected user page" do
						before do
						...
						describe "after signing in" do 
							it "should render the desiered protected page" do
			...
			describe "as wrong user" do
				let(:user) {FactoryGirl.create(:user)}
				let(:wrong_user) {FactoryGirl.create(:user, email:"another_email@mail.ru")}
				...
				describe "submittion a PATCH request to the User update action" do
